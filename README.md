# AWS Project - Unicorn Rydes 

**App Deployed** - https://main.d3ddjx9lca180.amplifyapp.com/

## Introduction
Created a web application for a unicorn ride-sharing service called Unicorn Rydes.The app uses AWS IAM, Amplify, Cognito, Lambda, API Gateway and DynamoDB, with code stored in GitHub and incorporated into a CI/CD pipeline with Amplify.
...
4. Create node **Lambda** function ( table name should be correct ) along with Test Function code
